...
def merge_blocks(blocks : torch.Tensor,
    ...
    merged_image = F.fold(input=blocks, output_size=output_size, kernel_size=block_size, stride=block_size)
...
class InferencePipeline():
    ...
    def segment(self,
        ...
        out_blocks = self.infer(blocks, image_size)
    ...
    def compare(self,
        ...
        '''
        Models are trained under resolution of 0.3m/pixel, other resolutions are transformed to 0.3m/pixel.
        '''
